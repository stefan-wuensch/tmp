...
If everything looks correct on the "**Review**" page, **click the box** next to _"I acknowledge that this template might cause AWS CloudFormation to create IAM resources."_
