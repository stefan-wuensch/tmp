...
- `aws.test.huit.harvard.edu` as the first part of `host_name` - **this is the value from the `SiteName` Parameter, with dashes changed to dots**<br>
- `hdjhee21ma2vq6` as the second part of `host_name` - **this is the `MasterDB` Parameter from above**<br>
- `aws.test` as the first part of `_AWS_Data` - **this is a short form of `SiteName` which is used in Nagios displays**<br>
